...
import { v4 } from 'uuid';
import { removeTask, selectEditTask, addTask } from '../actions';
...
class ToDoAdd extends React.Component{
    ...
    renderList(){
        const { list, removeTask, selectEditTask } = this.props;
            ...
            return(
                <li key={item.id} className={(index % 2) ? "bg-light" : "bg-white"}>
                    <div className="row">
                        ...
                        <div className="col-lg-2 col-3">
                            <button className="btn btn-dark" id="editBtn" onClick={() => selectEditTask(item)}>
